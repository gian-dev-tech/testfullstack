...
<body>
    ...
    <div class="container">
        ...
        <script>
            ...
            function selectBarang(id, kode, nama, harga, stok) {
                // Check if barang already exists in the table
                var exists = false;
    ...
    console.log('Diskon:', diskon); // Debugging
    console.log('Ongkir:', ongkir); // Debugging
    console.log('Total Bayar:', totalBayar); // Debugging
    ...
    $('#total_bayar').val(totalBayar.toFixed(2));
            ...
            $(document).on('input', 'input[name$="[qty]"], input[name$="[diskon_pct]"], input[name$="[diskon_nilai]"], #diskon, #ongkir', function() {
